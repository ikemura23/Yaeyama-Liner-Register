...
public class PreferenceUtils {
    ...
    // private static final LogHelper LogHelper = new
    // LogHelper(PreferenceUtils.class);
    private static String defaultName = PreferenceUtils.class.getCanonicalName();
